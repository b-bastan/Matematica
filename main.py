try:
    ...
    print("Ha ocurrido un error. Probablemente la versión instalada de Python no es compatible con los módulos requeridos. Comprobar con 'python --version', ya que la version debería ser la 3.10.6.")